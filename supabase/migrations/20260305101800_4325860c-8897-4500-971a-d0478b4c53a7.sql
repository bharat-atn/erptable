...
BEGIN
  ...
  -- Get the org_id from the employee record
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO contracts (employee_id, org_id, season_year)
    VALUES (_invitation.employee_id, _employee_org_id, extract(year from now())::text);
  END IF;
END;
$$;