...
import { MinusCircle, Info, Calculator } from "lucide-react";
  ...
  return (
    <div className="space-y-6 pt-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Avdrag & Förmåner • Payroll deductions and taxable benefits</p>
      </div>
