      ...
      <div className="grid grid-cols-7 gap-3">
        ...
        <div className="col-span-2 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Card className={cn("cursor-pointer transition-all", statusFilter === "INVITED" ? "border-2 border-primary bg-primary/5" : "hover:border-primary/50")} onClick={() => handleFilterClick("INVITED")}><CardContent className="p-4"><div className="flex items-center gap-1.5 mb-1"><Clock className="w-3.5 h-3.5 text-muted-foreground" /><span className="text-xs font-medium text-muted-foreground">Invited</span></div><p className="text-2xl font-bold">{invited}</p><p className="text-[10px] text-muted-foreground">{invitationStats?.sent || 0} emails sent</p></CardContent></Card>
