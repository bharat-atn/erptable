...
<style>
  ...
  .field-label { font-size: 8px; text-transform: uppercase; color: #888; letter-spacing: 0.3px; }
  .field-value { font-size: 11px; font-weight: 600; padding: 2px 0; border-bottom: 1px dotted #ccc; min-height: 16px; }
