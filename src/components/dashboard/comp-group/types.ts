...
export const SEED_PER_GROUP = [
  ...
  },
  {
    ...
    classes: [
      ...
      { sla: "103", s1: 1.10, s2: 1.20, s3: 1.30, s4: 1.40, s5: 1.50, gross: 3100, net: 1095 },
      ...
      { sla: "111", s1: 0.70, s2: 0.80, s3: 0.90, s4: 1.00, s5: 1.10, gross: 4400, net: 1725 },
      { sla: "112", s1: 0.65, s2: 0.75, s3: 0.85, s4: 0.95, s5: 1.05, gross: 4625, net: 1850 },
      { sla: "113", s1: 0.60, s2: 0.70, s3: 0.80, s4: 0.90, s5: 1.00, gross: 4850, net: 2000 },
    ],
  },
  {
    typeLabel: "Planting Type 1",
