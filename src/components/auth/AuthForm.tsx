        ...
        <Card className="shadow-2xl border-border/40 backdrop-blur-sm bg-card/95 ring-1 ring-primary/10">
          <CardContent className="pt-8 pb-8 px-8 space-y-6">
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full h-[4.5rem] text-[1.15rem] gap-3 font-medium shadow-md hover:shadow-lg transition-all duration-200 rounded-full border border-border/60 bg-card text-foreground flex items-center justify-center disabled:opacity-50 disabled:pointer-events-none hover:bg-muted/40"
                disabled={isLoading}
