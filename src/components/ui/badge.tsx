  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        newHire: "border-transparent bg-primary/10 text-primary",
        renewal: "border-primary/50 text-primary bg-transparent",
        completed: "border-transparent bg-success/10 text-success",
        opened: "border-transparent bg-primary/10 text-primary",
